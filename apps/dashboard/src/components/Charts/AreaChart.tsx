...
interface AreaChartProps extends BaseChartProps, Partial<RealTimeChartProps> {
  smooth?: boolean;
  showDots?: boolean;
  showGrid?: boolean;
  showBrush?: boolean;
...
export const AreaChart: React.FC<AreaChartProps> = ({
  ...
  // Generate gradient definitions for each dataset
  ...
  }, [chartData.datasets, fillOpacity]);
